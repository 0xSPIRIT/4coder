...
#include "4coder_spirit_base_commands.cpp"
...
#include "4coder_vim_main.cpp"

function int vim_mode_normal() {
    return(vim_state.mode == VIM_Normal);
}

function int vim_mode_visual() {
    return(vim_state.mode == VIM_Visual);
}
...
CUSTOM_DOC("Fleury startup event")
{
    ...
    //~ NOTE(rjf): Initialize panels
    {
        ...
        View_ID compilation_view = 0;
        {
            ...
            view_set_split_pixel_size(app, compilation_view, 0);
