...
CUSTOM_DOC("Deletes char at cursor then goes into insert mode.")
{
    vim_delete_char(app);
...
CUSTOM_DOC("Replaces a line with nothing, auto-indents, and puts you into insert mode.")
{
