        ...
        switch (in.event.kind){
            ...
            case InputEventKind_KeyStroke:
            {
                switch (in.event.key.code){
                    case KeyCode_M: if (has_modifier(&in.event.key.modifiers, KeyCode_Control)) {
                        case KeyCode_Return:
                        case KeyCode_Tab:
                        {
                            void *user_data = 0;
                        ...
                        goto default_lister_input_key_press;
                    }
                    ...
                    case KeyCode_N: if (has_modifier(&in.event.key.modifiers, KeyCode_Control)) {
                    case KeyCode_Down:
                    {
                        if (lister->handlers.navigate != 0){
                            lister->handlers.navigate(app, view, lister, 1);
                    ...
                    default:
                    default_lister_input_key_press:
                    {
