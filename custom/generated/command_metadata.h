...
{ PROC_LINKS(close_all_code, 0), false, "close_all_code", 14, "Closes any buffer with a filename ending with an extension configured to be recognized as a code file type.", 107, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 829 },
...
{ PROC_LINKS(close_other_panel, 0), true, "close_other_panel", 17, "Closes the other panel.", 23, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 205 },
...
{ PROC_LINKS(command_lister, 0), true, "command_lister", 14, "Opens an interactive list of all registered commands.", 53, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 764 },
...
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2114 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1432 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1604 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1590 },
...
{ PROC_LINKS(f4_autocomplete_or_indent, 0), false, "f4_autocomplete_or_indent", 25, "Tries to autocomplete the word currently being typed, and inserts indentation if such a word is not found.", 106, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1048 },
{ PROC_LINKS(f4_backspace_alpha_numeric_or_camel_boundary, 0), false, "f4_backspace_alpha_numeric_or_camel_boundary", 44, "Deletes left to a alphanumeric or camel boundary.", 49, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 838 },
{ PROC_LINKS(f4_backspace_token_boundary, 0), false, "f4_backspace_token_boundary", 27, "Deletes left to a token boundary.", 33, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 824 },
{ PROC_LINKS(f4_bump_to_column, 0), false, "f4_bump_to_column", 17, "Insert the required number of spaces to get to a specified column number.", 73, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1723 },
...
{ PROC_LINKS(f4_comment_selection, 0), false, "f4_comment_selection", 20, "Performs VS-style commenting on the selected range.", 51, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1500 },
{ PROC_LINKS(f4_delete_alpha_numeric_or_camel_boundary, 0), false, "f4_delete_alpha_numeric_or_camel_boundary", 41, "Deletes right to an alphanumeric or camel boundary.", 51, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 847 },
{ PROC_LINKS(f4_delete_token_boundary, 0), false, "f4_delete_token_boundary", 24, "Deletes right to a token boundary.", 34, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 831 },
{ PROC_LINKS(f4_go_to_definition, 0), false, "f4_go_to_definition", 19, "Goes to the definition of the identifier under the cursor.", 58, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 186 },
{ PROC_LINKS(f4_go_to_definition_same_panel, 0), false, "f4_go_to_definition_same_panel", 30, "Goes to the definition of the identifier under the cursor in the same panel.", 76, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 198 },
...
{ PROC_LINKS(f4_home_first_non_whitespace, 0), false, "f4_home_first_non_whitespace", 28, "Goes to the beginning of the line.", 34, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 856 },
{ PROC_LINKS(f4_interactive_open_or_new_in_project, 0), true, "f4_interactive_open_or_new_in_project", 37, "Interactively open a file out of the file system, filtered to files only in the project.", 88, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1255 },
...
{ PROC_LINKS(f4_loc, 0), false, "f4_loc", 6, "Counts the lines of code in the current buffer, breaks it down by section, and outputs to the *loc* buffer.", 107, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1638 },
{ PROC_LINKS(f4_move_down_token_occurrence, 0), false, "f4_move_down_token_occurrence", 29, "Moves the cursor to the next occurrence of the token that the cursor is over.", 77, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 803 },
{ PROC_LINKS(f4_move_left, 0), false, "f4_move_left", 12, "Moves the cursor one character to the left.", 43, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 768 },
{ PROC_LINKS(f4_move_left_token_boundary, 0), false, "f4_move_left_token_boundary", 27, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 817 },
{ PROC_LINKS(f4_move_right, 0), false, "f4_move_right", 13, "Moves the cursor one character to the right.", 44, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 782 },
{ PROC_LINKS(f4_move_right_token_boundary, 0), false, "f4_move_right_token_boundary", 28, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 810 },
...
{ PROC_LINKS(f4_move_up_token_occurrence, 0), false, "f4_move_up_token_occurrence", 27, "Moves the cursor to the previous occurrence of the token that the cursor is over.", 81, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 796 },
{ PROC_LINKS(f4_open_project, 0), true, "f4_open_project", 15, "Open a project by navigating to the project file.", 49, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 422 },
...
{ PROC_LINKS(f4_remedy_open_cursor, 0), false, "f4_remedy_open_cursor", 21, "Opens the active panel's file in an actively-running RemedyBG instance, and moves to the cursor's line position.", 112, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1709 },
...
{ PROC_LINKS(f4_search_for_definition__current_file, 0), true, "f4_search_for_definition__current_file", 38, "List all definitions in the current file and jump to the one selected by the user.", 82, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 325 },
{ PROC_LINKS(f4_search_for_definition__project_wide, 0), true, "f4_search_for_definition__project_wide", 38, "List all definitions in the index and jump to the one selected by the user.", 75, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 284 },
{ PROC_LINKS(f4_setup_new_project, 0), false, "f4_setup_new_project", 20, "Sets up a blank 4coder project provided some user folder.", 57, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 473 },
...
{ PROC_LINKS(f4_toggle_compilation_expand, 0), false, "f4_toggle_compilation_expand", 28, "Expand the compilation window.", 30, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 96 },
{ PROC_LINKS(f4_toggle_enclosure_side, 0), false, "f4_toggle_enclosure_side", 24, "Moves the cursor between the open/close brace/paren/bracket of the closest enclosure.", 85, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 365 },
{ PROC_LINKS(f4_uncomment_selection, 0), false, "f4_uncomment_selection", 22, "Performs VS-style uncommenting on the selected range.", 53, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1516 },
{ PROC_LINKS(f4_unindent, 0), false, "f4_unindent", 11, "Unindent the selected range.", 28, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1117 },
...
{ PROC_LINKS(fleury_go_to_definition, 0), false, "fleury_go_to_definition", 23, "Deprecated name. Please update to f4_go_to_definition.", 54, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1774 },
{ PROC_LINKS(fleury_go_to_definition_same_panel, 0), false, "fleury_go_to_definition_same_panel", 34, "Deprecated name. Please update to f4_go_to_definition_same_panel.", 65, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1777 },
{ PROC_LINKS(fleury_home, 0), false, "fleury_home", 11, "Deprecated name. Please update to f4_home.", 42, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1765 },
{ PROC_LINKS(fleury_startup, 0), false, "fleury_startup", 14, "Fleury startup event", 20, "d:\\Programs\\4codervim\\custom\\4coder_fleury.cpp", 46, 541 },
{ PROC_LINKS(fleury_toggle_battery_saver, 0), false, "fleury_toggle_battery_saver", 27, "Deprecated name. Please update to f4_toggle_battery_saver.", 58, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1768 },
{ PROC_LINKS(fleury_toggle_compilation_expand, 0), false, "fleury_toggle_compilation_expand", 32, "Deprecated name. Please update to f4_toggle_compilation_expand.", 63, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1771 },
{ PROC_LINKS(fleury_write_text_and_auto_indent, 0), false, "fleury_write_text_and_auto_indent", 33, "Deprecated name. Please update to f4_write_text_and_auto_indent.", 64, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1759 },
{ PROC_LINKS(fleury_write_text_input, 0), false, "fleury_write_text_input", 23, "Deprecated name. Please update to f4_write_text_input.", 54, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1756 },
{ PROC_LINKS(fleury_write_zero_struct, 0), false, "fleury_write_zero_struct", 24, "Deprecated name. Please update to f4_write_zero_struct.", 55, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1762 },
...
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2336 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2344 },
{ PROC_LINKS(goto_first_jump, 0), false, "goto_first_jump", 15, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer.", 95, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 525 },
{ PROC_LINKS(goto_first_jump_same_panel_sticky, 0), false, "goto_first_jump_same_panel_sticky", 33, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer and views the buffer in the panel where the jump list was.", 153, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 542 },
...
{ PROC_LINKS(goto_next_jump, 0), false, "goto_next_jump", 14, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 464 },
{ PROC_LINKS(goto_next_jump_no_skips, 0), false, "goto_next_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, and does not skip sub jump locations.", 132, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 494 },
{ PROC_LINKS(goto_prev_jump, 0), false, "goto_prev_jump", 14, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 481 },
{ PROC_LINKS(goto_prev_jump_no_skips, 0), false, "goto_prev_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, and does not skip sub jump locations.", 136, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 511 },
...
{ PROC_LINKS(if_read_only_goto_position, 0), false, "if_read_only_goto_position", 26, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 564 },
{ PROC_LINKS(if_read_only_goto_position_same_panel, 0), false, "if_read_only_goto_position_same_panel", 37, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor_same_panel.", 117, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 581 },
...
{ PROC_LINKS(interactive_kill_buffer, 0), true, "interactive_kill_buffer", 23, "Interactively kill an open buffer.", 34, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 524 },
{ PROC_LINKS(interactive_new, 0), true, "interactive_new", 15, "Interactively creates a new file.", 33, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 664 },
{ PROC_LINKS(interactive_open, 0), true, "interactive_open", 16, "Interactively opens a file.", 27, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 718 },
{ PROC_LINKS(interactive_open_or_new, 0), true, "interactive_open_or_new", 23, "Interactively open a file out of the file system.", 49, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 615 },
{ PROC_LINKS(interactive_switch_buffer, 0), true, "interactive_switch_buffer", 25, "Interactively switch to an open buffer.", 39, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 514 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1385 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1775 },
...
{ PROC_LINKS(list_all_locations, 0), false, "list_all_locations", 18, "Queries the user for a string and lists all exact case-sensitive matches found in all open buffers.", 99, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 168 },
{ PROC_LINKS(list_all_locations_case_insensitive, 0), false, "list_all_locations_case_insensitive", 35, "Queries the user for a string and lists all exact case-insensitive matches found in all open buffers.", 101, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 180 },
{ PROC_LINKS(list_all_locations_of_identifier, 0), false, "list_all_locations_of_identifier", 32, "Reads a token or word under the cursor and lists all exact case-sensitive mathces in all open buffers.", 102, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 192 },
{ PROC_LINKS(list_all_locations_of_identifier_case_insensitive, 0), false, "list_all_locations_of_identifier_case_insensitive", 49, "Reads a token or word under the cursor and lists all exact case-insensitive mathces in all open buffers.", 104, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 198 },
{ PROC_LINKS(list_all_locations_of_selection, 0), false, "list_all_locations_of_selection", 31, "Reads the string in the selected range and lists all exact case-sensitive mathces in all open buffers.", 102, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 204 },
{ PROC_LINKS(list_all_locations_of_selection_case_insensitive, 0), false, "list_all_locations_of_selection_case_insensitive", 48, "Reads the string in the selected range and lists all exact case-insensitive mathces in all open buffers.", 104, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 210 },
{ PROC_LINKS(list_all_locations_of_type_definition, 0), false, "list_all_locations_of_type_definition", 37, "Queries user for string, lists all locations of strings that appear to define a type whose name matches the input string.", 121, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 216 },
{ PROC_LINKS(list_all_locations_of_type_definition_of_identifier, 0), false, "list_all_locations_of_type_definition_of_identifier", 51, "Reads a token or word under the cursor and lists all locations of strings that appear to define a type whose name matches it.", 125, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 224 },
{ PROC_LINKS(list_all_substring_locations, 0), false, "list_all_substring_locations", 28, "Queries the user for a string and lists all case-sensitive substring matches found in all open buffers.", 103, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 174 },
{ PROC_LINKS(list_all_substring_locations_case_insensitive, 0), false, "list_all_substring_locations_case_insensitive", 45, "Queries the user for a string and lists all case-insensitive substring matches found in all open buffers.", 105, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 186 },
{ PROC_LINKS(load_project, 0), false, "load_project", 12, "Looks for a project.4coder file in the current directory and tries to load it.  Looks in parent directories until a project file is found or there are no more parents.", 167, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 856 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1544 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1584 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1578 },
...
{ PROC_LINKS(open_all_code, 0), false, "open_all_code", 13, "Open all code in the current directory. File types are determined by extensions. An extension is considered code based on the extensions specified in 4coder.config.", 164, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 838 },
{ PROC_LINKS(open_all_code_recursive, 0), false, "open_all_code_recursive", 23, "Works as open_all_code but also runs in all subdirectories.", 59, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 847 },
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1625 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2108 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1708 },
...
{ PROC_LINKS(project_command_F1, 0), false, "project_command_F1", 18, "Run the command with index 1", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1089 },
{ PROC_LINKS(project_command_F10, 0), false, "project_command_F10", 19, "Run the command with index 10", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1143 },
{ PROC_LINKS(project_command_F11, 0), false, "project_command_F11", 19, "Run the command with index 11", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1149 },
{ PROC_LINKS(project_command_F12, 0), false, "project_command_F12", 19, "Run the command with index 12", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1155 },
{ PROC_LINKS(project_command_F13, 0), false, "project_command_F13", 19, "Run the command with index 13", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1161 },
{ PROC_LINKS(project_command_F14, 0), false, "project_command_F14", 19, "Run the command with index 14", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1167 },
{ PROC_LINKS(project_command_F15, 0), false, "project_command_F15", 19, "Run the command with index 15", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1173 },
{ PROC_LINKS(project_command_F16, 0), false, "project_command_F16", 19, "Run the command with index 16", 29, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1179 },
{ PROC_LINKS(project_command_F2, 0), false, "project_command_F2", 18, "Run the command with index 2", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1095 },
{ PROC_LINKS(project_command_F3, 0), false, "project_command_F3", 18, "Run the command with index 3", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1101 },
{ PROC_LINKS(project_command_F4, 0), false, "project_command_F4", 18, "Run the command with index 4", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1107 },
{ PROC_LINKS(project_command_F5, 0), false, "project_command_F5", 18, "Run the command with index 5", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1113 },
{ PROC_LINKS(project_command_F6, 0), false, "project_command_F6", 18, "Run the command with index 6", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1119 },
{ PROC_LINKS(project_command_F7, 0), false, "project_command_F7", 18, "Run the command with index 7", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1125 },
{ PROC_LINKS(project_command_F8, 0), false, "project_command_F8", 18, "Run the command with index 8", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1131 },
{ PROC_LINKS(project_command_F9, 0), false, "project_command_F9", 18, "Run the command with index 9", 28, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1137 },
{ PROC_LINKS(project_command_lister, 0), false, "project_command_lister", 22, "Open a lister of all commands in the currently loaded project.", 62, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1041 },
{ PROC_LINKS(project_fkey_command, 0), false, "project_fkey_command", 20, "Run an 'fkey command' configured in a project.4coder file.  Determines the index of the 'fkey command' by which function key or numeric key was pressed to trigger the command.", 175, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 979 },
{ PROC_LINKS(project_go_to_root_directory, 0), false, "project_go_to_root_directory", 28, "Changes 4coder's hot directory to the root directory of the currently loaded project. With no loaded project nothing hapepns.", 125, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1005 },
{ PROC_LINKS(project_reprint, 0), false, "project_reprint", 15, "Prints the current project to the file it was loaded from; prints in the most recent project file version", 105, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1051 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1331 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1352 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1368 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1755 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1935 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2032 },
{ PROC_LINKS(reg, 0), false, "reg", 3, "Vim: Display registers", 22, "d:\\Programs\\4codervim\\custom\\4coder_vim_commands.cpp", 52, 93 },
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1509 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1793 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1241 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1232 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1223 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1164 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1176 },
...
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1783 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1476 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1158 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1170 },
{ PROC_LINKS(seek_beginning_of_line, 0), false, "seek_beginning_of_line", 22, "Seeks the cursor to the beginning of the visual line.", 53, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2324 },
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2312 },
{ PROC_LINKS(seek_end_of_line, 0), false, "seek_end_of_line", 16, "Seeks the cursor to the end of the visual line.", 47, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2330 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "d:\\Programs\\4codervim\\custom\\4coder_helper.cpp", 46, 2318 },
...
{ PROC_LINKS(setup_build_bat, 0), false, "setup_build_bat", 15, "Queries the user for several configuration options and initializes a new build batch script.", 92, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1023 },
{ PROC_LINKS(setup_build_bat_and_sh, 0), false, "setup_build_bat_and_sh", 22, "Queries the user for several configuration options and initializes a new build batch script.", 92, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1035 },
{ PROC_LINKS(setup_build_sh, 0), false, "setup_build_sh", 14, "Queries the user for several configuration options and initializes a new build shell script.", 92, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1029 },
{ PROC_LINKS(setup_new_project, 0), false, "setup_new_project", 17, "Queries the user for several configuration options and initializes a new 4coder project with build scripts for every OS.", 120, "d:\\Programs\\4codervim\\custom\\4coder_project_commands.cpp", 56, 1016 },
...
{ PROC_LINKS(spirit_close_compilation, 0), false, "spirit_close_compilation", 24, "Closes fleury's compilation view. Use Ctrl+Shift+M to toggle back!", 66, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 67 },
{ PROC_LINKS(spirit_execute_cli, 0), false, "spirit_execute_cli", 18, "Queries for a system command, runs the system command as a CLI and prints the output to the a new buffer.", 105, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 31 },
{ PROC_LINKS(spirit_open_goodies, 0), false, "spirit_open_goodies", 19, "Open goodies file.", 18, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 94 },
{ PROC_LINKS(spirit_open_project, 0), true, "spirit_open_project", 19, "Open a project by navigating to the project file.", 49, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 154 },
{ PROC_LINKS(spirit_open_search, 0), true, "spirit_open_search", 18, "Switches to the search buffer in another panel", 46, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 148 },
{ PROC_LINKS(spirit_open_url_line, 0), false, "spirit_open_url_line", 20, "Open URL at line.", 17, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 106 },
...
{ PROC_LINKS(spirit_swap_insert_cursor_type, 0), false, "spirit_swap_insert_cursor_type", 30, "Queries for a system command, runs the system command as a CLI and prints the output to the a new buffer.", 105, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 22 },
{ PROC_LINKS(spirit_transpose_chars, 0), false, "spirit_transpose_chars", 22, "Transpose two characters at cursor.", 35, "d:\\Programs\\4codervim\\custom\\4coder_spirit_base_commands.cpp", 60, 74 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1733 },
...
{ PROC_LINKS(theme_lister, 0), true, "theme_lister", 12, "Opens an interactive list of all registered themes.", 51, "d:\\Programs\\4codervim\\custom\\4coder_lists.cpp", 45, 788 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1883 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1961 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1721 },
...
{ PROC_LINKS(word_complete, 0), false, "word_complete", 13, "Iteratively tries completing the word to the left of the cursor with other words in open buffers that have the same prefix string.", 130, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 433 },
{ PROC_LINKS(word_complete_drop_down, 0), false, "word_complete_drop_down", 23, "Word complete with drop down menu.", 34, "d:\\Programs\\4codervim\\custom\\4coder_search.cpp", 46, 679 },
...
static i32 fcoder_metacmd_ID_vim_command_mode = 358;
static i32 fcoder_metacmd_ID_vim_dec_buffer_peek = 359;
static i32 fcoder_metacmd_ID_vim_inc_buffer_peek = 360;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 361;
static i32 fcoder_metacmd_ID_vim_jump_lister = 362;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 363;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 364;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_down = 365;
static i32 fcoder_metacmd_ID_vim_scoll_buffer_peek_up = 366;
static i32 fcoder_metacmd_ID_vim_switch_lister = 367;
static i32 fcoder_metacmd_ID_vim_theme_lister = 368;
static i32 fcoder_metacmd_ID_vim_toggle_relative_line_num = 369;
static i32 fcoder_metacmd_ID_vim_toggle_show_buffer_peek = 370;
static i32 fcoder_metacmd_ID_vim_try_exit = 371;
static i32 fcoder_metacmd_ID_vim_view_input_handler = 372;
static i32 fcoder_metacmd_ID_vs = 373;
static i32 fcoder_metacmd_ID_w = 374;
static i32 fcoder_metacmd_ID_word_complete = 375;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 376;
static i32 fcoder_metacmd_ID_wq = 377;
static i32 fcoder_metacmd_ID_wqa = 378;
