...
{ PROC_LINKS(clear_clipboard, 0), false, "clear_clipboard", 15, "Clears the history of the clipboard", 35, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 269 },
...
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2130 },
...
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1613 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1599 },
...
{ PROC_LINKS(f4_autocomplete_or_indent, 0), false, "f4_autocomplete_or_indent", 25, "Tries to autocomplete the word currently being typed, and inserts indentation if such a word is not found.", 106, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1067 },
{ PROC_LINKS(f4_backspace_alpha_numeric_or_camel_boundary, 0), false, "f4_backspace_alpha_numeric_or_camel_boundary", 44, "Deletes left to a alphanumeric or camel boundary.", 49, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 857 },
{ PROC_LINKS(f4_backspace_token_boundary, 0), false, "f4_backspace_token_boundary", 27, "Deletes left to a token boundary.", 33, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 843 },
{ PROC_LINKS(f4_bump_to_column, 0), false, "f4_bump_to_column", 17, "Insert the required number of spaces to get to a specified column number.", 73, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1742 },
...
{ PROC_LINKS(f4_comment_selection, 0), false, "f4_comment_selection", 20, "Performs VS-style commenting on the selected range.", 51, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1519 },
{ PROC_LINKS(f4_delete_alpha_numeric_or_camel_boundary, 0), false, "f4_delete_alpha_numeric_or_camel_boundary", 41, "Deletes right to an alphanumeric or camel boundary.", 51, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 866 },
{ PROC_LINKS(f4_delete_token_boundary, 0), false, "f4_delete_token_boundary", 24, "Deletes right to a token boundary.", 34, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 850 },
{ PROC_LINKS(f4_go_to_definition, 0), false, "f4_go_to_definition", 19, "Goes to the definition of the identifier under the cursor.", 58, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 205 },
{ PROC_LINKS(f4_go_to_definition_same_panel, 0), false, "f4_go_to_definition_same_panel", 30, "Goes to the definition of the identifier under the cursor in the same panel.", 76, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 217 },
...
{ PROC_LINKS(f4_home_first_non_whitespace, 0), false, "f4_home_first_non_whitespace", 28, "Goes to the beginning of the line.", 34, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 875 },
{ PROC_LINKS(f4_interactive_open_or_new_in_project, 0), true, "f4_interactive_open_or_new_in_project", 37, "Interactively open a file out of the file system, filtered to files only in the project.", 88, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1274 },
...
{ PROC_LINKS(f4_loc, 0), false, "f4_loc", 6, "Counts the lines of code in the current buffer, breaks it down by section, and outputs to the *loc* buffer.", 107, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1657 },
{ PROC_LINKS(f4_move_down_token_occurrence, 0), false, "f4_move_down_token_occurrence", 29, "Moves the cursor to the next occurrence of the token that the cursor is over.", 77, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 822 },
{ PROC_LINKS(f4_move_left, 0), false, "f4_move_left", 12, "Moves the cursor one character to the left.", 43, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 787 },
{ PROC_LINKS(f4_move_left_token_boundary, 0), false, "f4_move_left_token_boundary", 27, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 836 },
{ PROC_LINKS(f4_move_right, 0), false, "f4_move_right", 13, "Moves the cursor one character to the right.", 44, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 801 },
{ PROC_LINKS(f4_move_right_token_boundary, 0), false, "f4_move_right_token_boundary", 28, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 829 },
...
{ PROC_LINKS(f4_move_up_token_occurrence, 0), false, "f4_move_up_token_occurrence", 27, "Moves the cursor to the previous occurrence of the token that the cursor is over.", 81, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 815 },
{ PROC_LINKS(f4_open_project, 0), true, "f4_open_project", 15, "Open a project by navigating to the project file.", 49, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 441 },
...
{ PROC_LINKS(f4_remedy_open_cursor, 0), false, "f4_remedy_open_cursor", 21, "Opens the active panel's file in an actively-running RemedyBG instance, and moves to the cursor's line position.", 112, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1728 },
...
{ PROC_LINKS(f4_search_for_definition__current_file, 0), true, "f4_search_for_definition__current_file", 38, "List all definitions in the current file and jump to the one selected by the user.", 82, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 344 },
{ PROC_LINKS(f4_search_for_definition__project_wide, 0), true, "f4_search_for_definition__project_wide", 38, "List all definitions in the index and jump to the one selected by the user.", 75, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 303 },
{ PROC_LINKS(f4_setup_new_project, 0), false, "f4_setup_new_project", 20, "Sets up a blank 4coder project provided some user folder.", 57, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 492 },
...
{ PROC_LINKS(f4_toggle_compilation_expand, 0), false, "f4_toggle_compilation_expand", 28, "Expand the compilation window.", 30, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 102 },
{ PROC_LINKS(f4_toggle_enclosure_side, 0), false, "f4_toggle_enclosure_side", 24, "Moves the cursor between the open/close brace/paren/bracket of the closest enclosure.", 85, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 384 },
{ PROC_LINKS(f4_uncomment_selection, 0), false, "f4_uncomment_selection", 22, "Performs VS-style uncommenting on the selected range.", 53, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1535 },
{ PROC_LINKS(f4_unindent, 0), false, "f4_unindent", 11, "Unindent the selected range.", 28, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1136 },
...
{ PROC_LINKS(fleury_go_to_definition, 0), false, "fleury_go_to_definition", 23, "Deprecated name. Please update to f4_go_to_definition.", 54, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1793 },
{ PROC_LINKS(fleury_go_to_definition_same_panel, 0), false, "fleury_go_to_definition_same_panel", 34, "Deprecated name. Please update to f4_go_to_definition_same_panel.", 65, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1796 },
{ PROC_LINKS(fleury_home, 0), false, "fleury_home", 11, "Deprecated name. Please update to f4_home.", 42, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1784 },
{ PROC_LINKS(fleury_startup, 0), false, "fleury_startup", 14, "Fleury startup event", 20, "d:\\Programs\\4codervim\\custom\\4coder_fleury.cpp", 46, 550 },
{ PROC_LINKS(fleury_toggle_battery_saver, 0), false, "fleury_toggle_battery_saver", 27, "Deprecated name. Please update to f4_toggle_battery_saver.", 58, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1787 },
{ PROC_LINKS(fleury_toggle_compilation_expand, 0), false, "fleury_toggle_compilation_expand", 32, "Deprecated name. Please update to f4_toggle_compilation_expand.", 63, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1790 },
{ PROC_LINKS(fleury_write_text_and_auto_indent, 0), false, "fleury_write_text_and_auto_indent", 33, "Deprecated name. Please update to f4_write_text_and_auto_indent.", 64, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1778 },
{ PROC_LINKS(fleury_write_text_input, 0), false, "fleury_write_text_input", 23, "Deprecated name. Please update to f4_write_text_input.", 54, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1775 },
{ PROC_LINKS(fleury_write_zero_struct, 0), false, "fleury_write_zero_struct", 24, "Deprecated name. Please update to f4_write_zero_struct.", 55, "d:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1781 },
...
{ PROC_LINKS(goto_first_jump, 0), false, "goto_first_jump", 15, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer.", 95, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 539 },
{ PROC_LINKS(goto_first_jump_same_panel_sticky, 0), false, "goto_first_jump_same_panel_sticky", 33, "If a buffer containing jump locations has been locked in, goes to the first jump in the buffer and views the buffer in the panel where the jump list was.", 153, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 556 },
...
{ PROC_LINKS(goto_next_jump, 0), false, "goto_next_jump", 14, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 478 },
{ PROC_LINKS(goto_next_jump_no_skips, 0), false, "goto_next_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, and does not skip sub jump locations.", 132, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 508 },
{ PROC_LINKS(goto_prev_jump, 0), false, "goto_prev_jump", 14, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 495 },
{ PROC_LINKS(goto_prev_jump_no_skips, 0), false, "goto_prev_jump_no_skips", 23, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, and does not skip sub jump locations.", 136, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 525 },
...
{ PROC_LINKS(if_read_only_goto_position, 0), false, "if_read_only_goto_position", 26, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 578 },
{ PROC_LINKS(if_read_only_goto_position_same_panel, 0), false, "if_read_only_goto_position_same_panel", 37, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor_same_panel.", 117, "d:\\Programs\\4codervim\\custom\\4coder_jump_sticky.cpp", 51, 595 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1791 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1553 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1593 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1587 },
...
{ PROC_LINKS(multi_paste, 0), false, "multi_paste", 11, "Paste multiple entries from the clipboard at once", 49, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 277 },
{ PROC_LINKS(multi_paste_interactive, 0), false, "multi_paste_interactive", 23, "Paste multiple lines from the clipboard history, controlled with arrow keys", 75, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 419 },
{ PROC_LINKS(multi_paste_interactive_quick, 0), false, "multi_paste_interactive_quick", 29, "Paste multiple lines from the clipboard history, controlled by inputing the number of lines to paste", 100, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 428 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1638 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2124 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1724 },
...
{ PROC_LINKS(paste, 0), false, "paste", 5, "At the cursor, insert the text at the top of the clipboard.", 59, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 170 },
...
{ PROC_LINKS(paste_next_and_indent, 0), false, "paste_next_and_indent", 21, "Paste the next item on the clipboard and run auto-indent on the newly pasted text.", 82, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 262 },
...
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1771 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1951 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 2048 },
...
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1809 },
...
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1799 },
...
{ PROC_LINKS(spirit_paste_and_indent, 0), false, "spirit_paste_and_indent", 23, "Spirit's own paste & indent implementation using win32", 54, "d:\\Programs\\4codervim\\custom\\4coder_clipboard.cpp", 49, 163 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1749 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1899 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1977 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "d:\\Programs\\4codervim\\custom\\4coder_base_commands.cpp", 53, 1737 },
