...
{ PROC_LINKS(f4_autocomplete_or_indent, 0), false, "f4_autocomplete_or_indent", 25, "Tries to autocomplete the word currently being typed, and inserts indentation if such a word is not found.", 106, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1066 },
{ PROC_LINKS(f4_backspace_alpha_numeric_or_camel_boundary, 0), false, "f4_backspace_alpha_numeric_or_camel_boundary", 44, "Deletes left to a alphanumeric or camel boundary.", 49, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 856 },
{ PROC_LINKS(f4_backspace_token_boundary, 0), false, "f4_backspace_token_boundary", 27, "Deletes left to a token boundary.", 33, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 842 },
{ PROC_LINKS(f4_bump_to_column, 0), false, "f4_bump_to_column", 17, "Insert the required number of spaces to get to a specified column number.", 73, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1741 },
...
{ PROC_LINKS(f4_comment_selection, 0), false, "f4_comment_selection", 20, "Performs VS-style commenting on the selected range.", 51, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1518 },
{ PROC_LINKS(f4_delete_alpha_numeric_or_camel_boundary, 0), false, "f4_delete_alpha_numeric_or_camel_boundary", 41, "Deletes right to an alphanumeric or camel boundary.", 51, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 865 },
{ PROC_LINKS(f4_delete_token_boundary, 0), false, "f4_delete_token_boundary", 24, "Deletes right to a token boundary.", 34, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 849 },
{ PROC_LINKS(f4_go_to_definition, 0), false, "f4_go_to_definition", 19, "Goes to the definition of the identifier under the cursor.", 58, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 204 },
{ PROC_LINKS(f4_go_to_definition_same_panel, 0), false, "f4_go_to_definition_same_panel", 30, "Goes to the definition of the identifier under the cursor in the same panel.", 76, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 216 },
...
{ PROC_LINKS(f4_home_first_non_whitespace, 0), false, "f4_home_first_non_whitespace", 28, "Goes to the beginning of the line.", 34, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 874 },
{ PROC_LINKS(f4_interactive_open_or_new_in_project, 0), true, "f4_interactive_open_or_new_in_project", 37, "Interactively open a file out of the file system, filtered to files only in the project.", 88, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1273 },
...
{ PROC_LINKS(f4_loc, 0), false, "f4_loc", 6, "Counts the lines of code in the current buffer, breaks it down by section, and outputs to the *loc* buffer.", 107, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1656 },
{ PROC_LINKS(f4_move_down_token_occurrence, 0), false, "f4_move_down_token_occurrence", 29, "Moves the cursor to the next occurrence of the token that the cursor is over.", 77, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 821 },
{ PROC_LINKS(f4_move_left, 0), false, "f4_move_left", 12, "Moves the cursor one character to the left.", 43, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 786 },
{ PROC_LINKS(f4_move_left_token_boundary, 0), false, "f4_move_left_token_boundary", 27, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 835 },
{ PROC_LINKS(f4_move_right, 0), false, "f4_move_right", 13, "Moves the cursor one character to the right.", 44, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 800 },
{ PROC_LINKS(f4_move_right_token_boundary, 0), false, "f4_move_right_token_boundary", 28, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 828 },
...
{ PROC_LINKS(f4_move_up_token_occurrence, 0), false, "f4_move_up_token_occurrence", 27, "Moves the cursor to the previous occurrence of the token that the cursor is over.", 81, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 814 },
{ PROC_LINKS(f4_open_project, 0), true, "f4_open_project", 15, "Open a project by navigating to the project file.", 49, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 440 },
...
{ PROC_LINKS(f4_remedy_open_cursor, 0), false, "f4_remedy_open_cursor", 21, "Opens the active panel's file in an actively-running RemedyBG instance, and moves to the cursor's line position.", 112, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1727 },
...
{ PROC_LINKS(f4_search_for_definition__current_file, 0), true, "f4_search_for_definition__current_file", 38, "List all definitions in the current file and jump to the one selected by the user.", 82, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 343 },
{ PROC_LINKS(f4_search_for_definition__project_wide, 0), true, "f4_search_for_definition__project_wide", 38, "List all definitions in the index and jump to the one selected by the user.", 75, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 302 },
{ PROC_LINKS(f4_setup_new_project, 0), false, "f4_setup_new_project", 20, "Sets up a blank 4coder project provided some user folder.", 57, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 491 },
...
{ PROC_LINKS(f4_toggle_compilation_expand, 0), false, "f4_toggle_compilation_expand", 28, "Expand the compilation window.", 30, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 101 },
{ PROC_LINKS(f4_toggle_enclosure_side, 0), false, "f4_toggle_enclosure_side", 24, "Moves the cursor between the open/close brace/paren/bracket of the closest enclosure.", 85, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 383 },
{ PROC_LINKS(f4_uncomment_selection, 0), false, "f4_uncomment_selection", 22, "Performs VS-style uncommenting on the selected range.", 53, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1534 },
{ PROC_LINKS(f4_unindent, 0), false, "f4_unindent", 11, "Unindent the selected range.", 28, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1135 },
...
{ PROC_LINKS(fleury_go_to_definition, 0), false, "fleury_go_to_definition", 23, "Deprecated name. Please update to f4_go_to_definition.", 54, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1792 },
{ PROC_LINKS(fleury_go_to_definition_same_panel, 0), false, "fleury_go_to_definition_same_panel", 34, "Deprecated name. Please update to f4_go_to_definition_same_panel.", 65, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1795 },
{ PROC_LINKS(fleury_home, 0), false, "fleury_home", 11, "Deprecated name. Please update to f4_home.", 42, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1783 },
...
{ PROC_LINKS(fleury_toggle_battery_saver, 0), false, "fleury_toggle_battery_saver", 27, "Deprecated name. Please update to f4_toggle_battery_saver.", 58, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1786 },
{ PROC_LINKS(fleury_toggle_compilation_expand, 0), false, "fleury_toggle_compilation_expand", 32, "Deprecated name. Please update to f4_toggle_compilation_expand.", 63, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1789 },
{ PROC_LINKS(fleury_write_text_and_auto_indent, 0), false, "fleury_write_text_and_auto_indent", 33, "Deprecated name. Please update to f4_write_text_and_auto_indent.", 64, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1777 },
{ PROC_LINKS(fleury_write_text_input, 0), false, "fleury_write_text_input", 23, "Deprecated name. Please update to f4_write_text_input.", 54, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1774 },
{ PROC_LINKS(fleury_write_zero_struct, 0), false, "fleury_write_zero_struct", 24, "Deprecated name. Please update to f4_write_zero_struct.", 55, "D:\\Programs\\4codervim\\custom\\4coder_fleury_base_commands.cpp", 60, 1780 },
