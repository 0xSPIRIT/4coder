...
enum {
    SPIRIT_INSERT_CURSOR_BLOCK,
    SPIRIT_INSERT_CURSOR_LINE
};
int spirit_insert_cursor_type = SPIRIT_INSERT_CURSOR_BLOCK;
CUSTOM_ID(colors, defcolor_insert_cursor_color);
